...
namespace Projeto.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,vlrUnitario")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,vlrUnitario")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
